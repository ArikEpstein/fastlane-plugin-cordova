module Fastlane
  module Actions
    class SignAndroidAction < Action
      def self.run(params)
        keystore_path = Fastlane::Actions::AndroidKeystoreAction.run(params)
